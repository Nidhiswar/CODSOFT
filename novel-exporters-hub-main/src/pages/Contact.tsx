          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-6 rounded-2xl bg-card border border-border card-hover animate-fade-in">
                  <div className="w-12 h-12 rounded-xl gradient-leaf flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-4 p-6 rounded-2xl bg-card border border-border card-hover animate-fade-in" style={{ animationDelay: '100ms' }}>
                  <div className="w-12 h-12 rounded-xl gradient-warm flex items-center justify-center flex-shrink-0">
                    <Phone className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="font-semibold font-serif text-foreground mb-1">Phone</h3>
                    <p className="text-muted-foreground text-sm">Available Mon-Sat, 9AM-6PM IST</p>
            ...
            <div className="relative">
              <div className="aspect-square lg:aspect-auto lg:h-full rounded-3xl overflow-hidden shadow-2xl">
                <iframe
